...
var FLBuilderLayoutConfig={anchorLinkAnimations:{duration:1000,easing:'swing',offset:100},paths:{pluginUrl:'http://themes.kakeestudio.com/annawolf/wp-content/plugins/beaver-builder-lite-version/',wpAjaxUrl:'http://themes.kakeestudio.com/annawolf/wp-admin/admin-ajax.php'}};(function($){if(typeof FLBuilderLayout!='undefined'){return;}
...
{var hash=window.location.hash.replace('#','').split('http://themes.kakeestudio.com/').shift(),element=null,tabs=null,responsiveLabel=null,tabIndex=null,label=null;if(''!==hash){element=$('#'+hash);if(element.length>0){if(element.hasClass('fl-accordion-item')){setTimeout(function(){element.find('.fl-accordion-button').trigger('click');},100);}
...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){FLBuilderLayout.init();});})(jQuery);var wpAjaxUrl='../wp-admin/admin-ajax.html';var flBuilderUrl='../wp-content/plugins/beaver-builder-lite-version/index.html';